defmodule UnifiedUi.Renderers.CoordinatorTest do
  @moduledoc """
  Tests for UnifiedUi.Renderers.Coordinator
  """

  use ExUnit.Case, async: true

  alias UnifiedUi.Renderers.Coordinator
  ...
  describe "renderer selection" do
    ...
    test "select_renderers/1 returns multiple renderers" do
      ...
      assert UnifiedUi.Renderers.Terminal in renderers
      assert UnifiedUi.Renderers.Web in renderers
