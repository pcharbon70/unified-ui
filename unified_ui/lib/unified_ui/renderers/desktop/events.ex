defmodule UnifiedUi.Renderers.Desktop.Events do
  @moduledoc """
  ...
  Triggered by button press in the desktop window:
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.to_signal(
        :click,
  ...
  Dispatch signals to the JidoSignal bus:
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.dispatch(
        :click,
  ...
  ## Examples
      ...
      iex> UnifiedUi.Renderers.Desktop.Events.event_types()
  ...
  ## Examples
      ...
      iex> UnifiedUi.Renderers.Desktop.Events.create_event(:click, %{widget_id: :btn})
  ...
  * `opts` - Options passed to signal creation
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.button_click(
        :submit_button,
        :submit_form
      )
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.input_change(
        :email_input,
        "user@example.com"
      )
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.form_submit(
        :login_form,
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.key_press(:enter, [])

      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.key_press(:char, [?a])

      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.key_press(:s, [:ctrl])  # Ctrl+S
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.mouse_click(
        :my_button,
        :left,
        100,
        200
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.mouse_double_click(
        :my_item,
        :left,
        150,
        250
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.mouse_move(100, 200)

      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.mouse_move(150, 300, [:left, :right])
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.mouse_scroll(100, 200, :down, 3)
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.window_resize(800, 600)
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.window_move(100, 50)
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.window_close()
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.window_minimize()
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.window_maximize()
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.window_restore()
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.window_focus()
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Desktop.Events.window_blur()
  ...
  ## Examples
      ...
      handlers = UnifiedUi.Renderers.Desktop.Events.extract_handlers(render_tree)
