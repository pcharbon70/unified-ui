defmodule UnifiedUi.Renderers.Web.Events do
  @moduledoc """
  ...
  Dispatch signals to the JidoSignal bus:
      ...
      {:ok, signal} = UnifiedUi.Renderers.Web.Events.dispatch(
        :click,
  ...
  Form submissions include all field values:
      ...
      {:ok, signal} = UnifiedUi.Renderers.Web.Events.form_submit(
        :login_form,
  ...
  ## Examples
      ...
      iex> UnifiedUi.Renderers.Web.Events.event_types()
  ...
  ## Examples
      ...
      iex> UnifiedUi.Renderers.Web.Events.create_event(:click, %{widget_id: :btn})
  ...
  * `:subject` - Optional subject for the signal
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Web.Events.to_signal(
        :click,
  ...
  * `opts` - Options passed to signal creation
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Web.Events.button_click(
        :submit_button,
        :submit_form
      )
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Web.Events.input_change(
        :email_input,
        "user@example.com"
      )
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Web.Events.key_press(:enter, [])

      {:ok, signal} = UnifiedUi.Renderers.Web.Events.key_press(:char, [?a])

      {:ok, signal} = UnifiedUi.Renderers.Web.Events.key_press(:s, [:ctrl])  # Ctrl+S
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Web.Events.key_release(:enter, [])
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Web.Events.hook_event(
        :scroll_handler,
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Web.Events.ws_connecting()
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Web.Events.ws_connected()
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Web.Events.ws_disconnected()
  ...
  ## Examples
      ...
      {:ok, signal} = UnifiedUi.Renderers.Web.Events.ws_reconnecting(3, 2000)
  ...
  ## Examples
      ...
      handlers = UnifiedUi.Renderers.Web.Events.extract_handlers(render_tree)
