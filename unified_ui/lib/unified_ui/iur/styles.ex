defmodule UnifiedUi.IUR.Style do
  @moduledoc """
  ...
  * `:reverse` - Reverse video (swapped fg/bg)
  ...
  Create a simple style:
      ...
      iex> UnifiedUi.IUR.Style.new(fg: :blue, bg: :white)
      %UnifiedUi.IUR.Style{fg: :blue, bg: :white, attrs: [], padding: nil, ...}

  Create a style with text attributes:

      iex> UnifiedUi.IUR.Style.new(fg: :red, attrs: [:bold, :underline])
      %UnifiedUi.IUR.Style{fg: :red, attrs: [:bold, :underline], ...}

  Merge two styles (later values override earlier):

      iex> base = UnifiedUi.IUR.Style.new(fg: :blue, padding: 2)
      iex> override = UnifiedUi.IUR.Style.new(fg: :red, margin: 1)
      iex> UnifiedUi.IUR.Style.merge(base, override)
      %UnifiedUi.IUR.Style{fg: :red, padding: 2, margin: 1, bg: nil, ...}
