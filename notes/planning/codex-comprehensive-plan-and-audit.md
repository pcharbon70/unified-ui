...
Status: root-level diff-aware updates complete; desktop root-layout child incremental patching complete; deeper/nested and terminal/web subtree patching remains.
